...
export default function NavBar(){
  ...
  <div>
    ...
    <div className='div_nav_responsive'>
      <div className={isActive ? 'icon iconActive' : 'icon'} onClick={toggleNavBar}>
      ...
      <div className={isActive ? 'menu menuOpen': 'menu menuClose'}>
        <div className="nav-bar_responsive">
          <Link to='/' className='link-responsive'>Home</Link>
          <Link to='/about' className='link-responsive'>About</Link>
          <Link to='/works' className='link-responsive'>Portifolio</Link>
          <Link to='/contact-me' className='link-responsive'>Contact</Link>
      </div>
      </div>
    </div>
  </div>
